...
//    }
    ...
    {
        $this->state = $this->stateFieldAssessor();
        $this->finiteLoader = $config ?: $this->stateMachineConfig();
        $loader = new ArrayLoader($this->finiteLoader);
     ...
     * @return mixed
     */
    protected function stateFieldAssessor()
    {
        if (isset( $this->attributes[$this->stateField])) {
            return $this->attributes[$this->stateField];
        }
    }
